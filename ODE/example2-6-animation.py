...
fig.suptitle(fr"Damped Pendulum Motion Animation $q={q}$", fontsize=16)
ani = animation.FuncAnimation(fig, func, frames=nstep, fargs=(line1, circle1, u_list),repeat=False, interval=dt * 0.1)
ani.save("damped_pendulum_animation_q0.5damped_pendulum_animation_q0.5.gif", writer="pillow", fps=20)
pl.show()
